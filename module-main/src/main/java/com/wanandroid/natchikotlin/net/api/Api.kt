package com.wanandroid.natchikotlin.net.api
...
interface Api {
    ...
    //https://wanandroid.com/wenda/list/1/json 每日一问
    @GET("/wenda/list/{id}/json ")
    suspend fun getWenda(@Path("id") pageId: Int ) : ApiResponse<PageBean<PageItemBean>>
}
