...
class RadarView @JvmOverloads constructor(
    ...
    private fun getAttrs(context: Context, attrs: AttributeSet?) {
        if (attrs != null) {
            ...
            mCircleColor =
                mTypedArray.getColor(R.styleable.RadarView_circleColor, DEFAULT_COLOR)
            ...
            mRaindropColor =
                mTypedArray.getColor(R.styleable.RadarView_raindropColor, DEFAULT_COLOR)
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        //设置宽高,默认200dp
        val defaultSize = dp2px(context, defaultSize)
    ...
    private fun generateRaindrop(cx: Int, cy: Int, radius: Int) {
        ...
        if (mRaindrops.size < mRaindropNum) {
            ...
            if (probability) {
                ...
                val yOffset =
                    (Math.random() * Math.sqrt(1.0 * (radius - 20).toDouble() * (radius - 20).toDouble() - xOffset * xOffset).toInt()).toInt()
